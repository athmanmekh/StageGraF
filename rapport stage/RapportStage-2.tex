...
J'ai donné a quelque interface un nom plus court, par exemple j'ai ajouté \texteit{import static graph.Graph.Edge;} pour avoir \textit{Edge} au lieu de \textit{Graph.Edge}.\newline
